...
class CustomComponent extends Component {
    ...
    public function getProjectUrl($category, $id, $title = null) {
        return HTTP_ROOT . "project/" . $this->makeSeoUrl($category) . "/" . $id . "-" . $this->makeSeoUrl($title);
    }
...
//          $extname = substr(strrchr($image, "."), 1);
    ...
    <td width="150" style="font:12px Helvetica,sans-serif;color:#7b7b7b">EMAIL:<a target="_blank" style="text-decoration:none" href="mailto:contact@free4lancer.com"><font color="#f67d2c"> contact@free4lancer.com </font></a></td>
